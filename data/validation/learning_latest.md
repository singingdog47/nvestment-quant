...
Generated: 2026-09-10T07:31:31+00:00

This is a diagnostic learning layer. It does not automatically change factor weights or issue orders.

## Model-change gate
- Matured absolute-return observations: 51
- Benchmark-relative observations: 51
- Minimum benchmark-relative observations for review: 60
- Eligible for human model-change review: False

## Findings
- [INFO] regime / CONSTRUCTIVE|1w (n=51): Benchmark-relative performance is historically positive; retain for monitoring, not automatic promotion.
