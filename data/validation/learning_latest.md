...
Generated: 2026-09-15T07:32:46+00:00

This is a diagnostic learning layer. It does not automatically change factor weights or issue orders.

## Model-change gate
- Matured absolute-return observations: 71
- Benchmark-relative observations: 71
- Minimum benchmark-relative observations for review: 60
- Eligible for human model-change review: True

## Findings
- [INFO] regime / CONSTRUCTIVE|1w (n=71): Benchmark-relative performance is historically positive; retain for monitoring, not automatic promotion.
