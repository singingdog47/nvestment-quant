...
市場レジームは**CONSTRUCTIVE**、総合スコアは62.8です。
...
- **WATCH** Market liquidity is soft — 売買指示ではなく確認対象です。
...
データ品質は74.5%。9568銘柄中5378銘柄を採点し、価格欠損率は9.3%です。
公式財務データが不足する場合は、証券会社画面と企業の公式開示を確認するまで注文しません。

生成時刻（UTC）：2026-09-21T15:54:32+00:00
