...
市場レジームは**CONSTRUCTIVE**、総合スコアは66.7です。
地合いの分類は変わっていませんが、流動性が前回より低下しています。市場のストレスと参加の広がりを見ながら、個別銘柄を選別する局面です。
...
米国債金利の実現ボラproxyは58パーセンタイルで、ICE MOVEとは別の公式米財務省データによる参考値です。
...
生成時刻（UTC）：2026-09-04T07:30:25+00:00
